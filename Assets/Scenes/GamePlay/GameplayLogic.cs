...
public class GameplayLogic : MonoBehaviour {
    ...
    void spawnPlayer()
    {
        ...
        var bullets = GameObject.FindGameObjectsWithTag("UsedBullet");
    ...
    void refreshBulletText()
    {
        if (playerShip)
        {
            this.bulletText.text = "Bullets: " + new string('I', playerShip.GetComponent<PlayerShipBehavior>().remainingBullet);
        }
    }
